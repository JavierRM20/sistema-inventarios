    ...
    <div class="accordion accordion-flush" id="menuAccordion">
            ...
            <div id="collapseProductos" 
                ...
                <div class="accordion-body bg-secondary">
                    <a href="{{ route('productos.index') }}" 
                       class="d-block text-light {{ request()->is('productos') ? 'fw-bold text-white' : '' }}">📦 Listar</a>
                    <a href="{{ route('productos.create') }}" 
                       class="d-block text-light {{ request()->is('productos/create') ? 'fw-bold text-white' : '' }}">➕ Crear</a>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item bg-dark text-light">
            ...
            <div id="collapseUsuarios" 
                 ...
                 data-bs-parent="#menuAccordion">
                <div class="accordion-body bg-secondary">
                    <a href="#" class="d-block text-light">📋 Listar</a>
                    <a href="#" class="d-block text-light">➕ Crear</a>
                </div>
            </div>
        </div>
